...
/**
 * Wrapper for LogicalResponse that implements VaultResponse interface
 */
class LogicalResponseWrapper implements VaultResponse {
  private final LogicalResponse logicalResponse;

  public LogicalResponseWrapper(LogicalResponse logicalResponse) {
